            ...
            <BottomNavigation height="400px">
                ...
                <TabContentItem>
                    <GridLayout>
                        ...
                        <ListView for="apartment in apartments"
                            @itemTap="onItemTap">
                            <v-template>
                                <StackLayout orientation="vertical"
                                    ...
                                    <Image :src="apartment.image"
                                        stretch="aspectFill" />
                                    <Label :text="apartment.title"
                                        class="h1" />
                                    <Label :text="apartment.name"
                                        class="h3" />
                                    <Label :text="'Rent: $' + apartment.rent"
                                        class="h3" />
                                </StackLayout>
                            </v-template>
                        </ListView>
                ...
                <TabContentItem>
                    <GridLayout>
                        ...
                        <ListView for="estate in estates"
                            @itemTap="onEstateTap" style="height:1250px">
                            <v-template>
                ...
                <TabContentItem>
                    <GridLayout>
                        ...
                        <ListView for="bedroom in bedrooms"
                            @itemTap="onBedroomTap" style="height:1250px">
                            <v-template>
                                <FlexboxLayout flexDirection="row">
                                    <Label :text="bedroom.description"
                ...
                <TabContentItem>
                    <GridLayout>
                        ...
                        <ListView for="profile in profiles"
                            @itemTap="onActionTap" style="height:1250px">
                            <v-template>
                                <FlexboxLayout flexDirection="row">
...
<script>
    ...
    export default {
        methods: {
            ...
            onBedroomTap: function(args) {
                ...
                this.$navigateTo(Bedroom, {
                    ...
                    transitionAndroid: {},
                    props: {
                        numberOfBedroom: args.item.quantity,
                        $delegate: this
                    }
                });
            },
            onActionTap: function(args) {
                console.log("Item with index: " + args.index + " tapped");
                console.log("Action:" + args.item.information);
                if (args.item.information == "Logoff / Login") {
                ...
                } else if (args.item.information == "My Rentals") {
        ...
        mounted() {
            ...
            this.festivalCity = this.apartments.filter(function(a) {
                return a.name == "Festival City";
            });
            this.tinMaCourt = this.apartments.filter(function(a) {
                return a.name == "Tin Ma Court";
            });
            this.cityOne = this.apartments.filter(function(a) {
                return a.name == "City One Shatin";
            });
        },
        ...
        data() {
            return {
                ...
                bedrooms: [{
                        description: "number Of bedroom <= 2",
                        quantity: 2
                    },
                    {
                        description: "number Of bedroom >= 3 ",
                        quantity: 3
                    }
                ],

                profiles: [{
                        information: "Logoff / Login"
                    },
                    {
                        information: "My Rentals"
                    }
                ],
